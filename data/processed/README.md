...
this data set uses the classifications from the 2025 fiscal year.
...
Description: This data set, contained in voluntary_contributions.parquet,
...
purposes and programs. In addition, this data set includes the total assessed
